  ...
  return (
    <div className="flex w-full justify-center items-center">
      ...
      <div className="rsu">  
       ...
       {/* ye mera arrow animation hai thika  */}
      ...
      <div className="container">
           <img src={CarImage} alt="Avatar" className="image" />
                <div className="middle">
                  <div className="text">car 4's addr:- {shortenAddress("0x635036A872162CB8A7f79abF9a46527e6C4290c8")} accident </div>
           </div>
        </div>
...
{isLoading
  ...
  : <>
    ...
    <Link to="W3"       className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] hover:bg-[#3d4f7c] rounded-full cursor-pointer"
>next page</Link>
