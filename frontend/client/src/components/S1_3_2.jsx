...
const Welcome = () => {
  ...
  return (
   ...
   <br /> 
          ...
          The Cars in the range of RSU will now perform V2V to send the information to the cars not in the range of RSU. Please Change your Metamask's account to car 6 and approve request...
          </p>
          {!currentAccount && (
            <button
              type="button"
