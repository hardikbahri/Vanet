  ...
  return (
   ...
   <br /> 
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
           The Cars in the range of RSU will now perform V2V to send the information to the cars not in the range of RSU. Please Change your Metamask's account to car1 and approve request...
          </p>
          {!currentAccount && (
            <button
              type="button"
