...
const Welcome = () => {
  ...
  return (
   ...
   <br /> 
          ...
          The Cars in the range of RSU will now perform V2V to send the information to the cars not in the range of RSU. Please Change your Metamask's account to car 4 and approve request...
          </p>
          {!currentAccount && (
            <button
              type="button"
      ...
      <div className="rsu">  
        <div className="container">
           <img src={RsuImage} alt="Avatar" className="image2" id="rsu2" />
                <div className="middle">
                <div className="text2">RSU's addr:- {shortenAddress("0x635036A872162CB8A7f79abF9a46527e6C4290c8")}</div>
                </div>
        </div>
      </div>
