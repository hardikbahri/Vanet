  ...
  return (
    ...
    <div className="flex mf:flex-row flex-col items-start justify-between md:p-10 py-5 px-10">
      <div className="flex flex-1 justify-start items-start flex-col">
           ...
           There are Multiple Malicious cars in the VANET
             <br /> 
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
          The trust evaluation algorithm marked  car 8,car 9 and car 10 as malicious. their trust score decreases to 0 
          </p>
          {!currentAccount && (
            <button
              type="button"
