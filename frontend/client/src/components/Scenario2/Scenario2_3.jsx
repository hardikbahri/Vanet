      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-10 ">
        <div className="flex flex-1 justify-start items-start flex-col">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient">
            Approve the Follwoing request...    <br /> 
          </h1>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
          A traffic jam event has happened at car 4(trusted) and it will now perform V2V to inform other cars in VANET. Change the account to car 4 and allow message transfer
