...
import {mal1,notmal2,notmal1} from "../../utils/constants"
...
const Welcome = () => {
  ...
  const DataJSON={
    ...
    "c1":{"CarName":mal1,"TrustScore":0},
    "c2":{"CarName":notmal1,"TrustScore":50},
    "c3":{"CarName":notmal2,"TrustScore":50}
    ...
    <div className="">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-10 ">
        <div className="flex flex-1 justify-start items-start flex-col">
          ...
          The cars which are in range of car 11 wants to send the information of the event change the account to car 10 
          </p>
          {!currentAccount && (
            <button
              type="button"
